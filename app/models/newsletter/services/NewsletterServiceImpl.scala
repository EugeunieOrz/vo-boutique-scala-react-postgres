...
class NewsletterServiceImpl @Inject() (newsletterDAO: NewsletterDAO)(
   ...
   */
  def retrieve(id: UUID): Future[Option[SubscribeToNewsletter]] = newsletterDAO.find(id)
   ...
   */
  def deleteSubscription(id: UUID): Future[Int] = newsletterDAO.removeSubscription(id)
}
